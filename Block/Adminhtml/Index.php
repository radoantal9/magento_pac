<?php
class Yoma_Bmicalculator_Block_Adminhtml_Index extends Mage_Core_Block_Template{
    ...
    public function getPlans() {
        ...
        $orders = $orderCollection->addAttributeToFilter("customer_id", $this->getRequest()->getParam('id'))->addAttributeToFilter('state', 'complete');
